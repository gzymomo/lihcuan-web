<template>
  <div class="go-in">
    <banner img="../assets/img/bgtop.jpg" title="走进力川" />
        ...
        <div class="content-summary">
          <div class="summary-left">
            ...
            <p class="content">
              ...
              上海华银日用品有限公司、中科建设开发总公司、
              广东怡轩房地产开发有限公司等多家知名企业。
              立人立己、达人达己！公司一直秉承“
      ...
      .then(
        this.$http.spread(
          (responseHonor, responseEnterprise, responseTeam, responseCourse) => {
            ...
            this.partnerImg = responseEnterprise.data.data;
            this.teamItem = responseTeam.data.data;

            var groupCount = Math.ceil(responseCourse.data.data.length / 2);
            window.console.log(groupCount);
            for (let i = 0; i < groupCount; i++) {
              let img2 = [];
              for (let j = 0; j < 2; j++) {
                if (responseCourse.data.data.length - 1 >= i * 2 + j) {
                  img2.push(responseCourse.data.data[i * 2 + j]);
                }
              }
