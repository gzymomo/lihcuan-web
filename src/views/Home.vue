  ...
  <div class="home" v-loading="loading">
    <swiper id="swiperBox" v-bind:options="swiperOption" ref="mySwiper">
      <swiper-slide class="swiper-slide slide-one">
        <div class="page">
          <h3>力川金属</h3>
          <p>Lichuan Metal Materials</p>
        </div>
        <p class="slogan">力聚金属，川通天下</p>
      </swiper-slide>
        ...
        <ul class="case-item">
          ...
          >
            <router-link
              ...
              :to="{ name: 'casedetails', params: { id: item.documentId } }"
            >
        ...
        <div class="news-content">
          <div class="news-content-item" v-for="(news, i) in newsList" :key="i">
            <div :style="'order: ' + (i % 2 == 0 ? 1 : 3)">
              <router-link
                class="text-decoration"
                :to="{ name: 'newsdetails', params: { id: news.documentId } }"
              >
                <div
                  class="item-img"
...
export default {
  ...
  mounted() {
    this.$http
      .all([
        this.$http.get("cases"),
        this.$http.get(`news?filters[Type][$eq]=1&pagination[3]`),
      ])
      .then(
...
// }
.slide-one {
  background: url(../assets/img/home_top.jpeg) no-repeat center;
  background-size: cover;
}
.slide-two {
  background: url(../assets/img/home_do.jpeg) no-repeat center;
  background-size: cover;
}
.slide-three {
